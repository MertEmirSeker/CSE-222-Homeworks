...
/**
 * The GUIVisualization class creates a graphical user interface to visualize performance data as a graph.
 */
public class GUIVisualization extends JFrame {
    ...
    private String graphTitle; // Title of the graph

    /**
     * Constructs a new GUIVisualization frame with the specified parameters.
     *
     ...
     */
    public GUIVisualization(String plotType, List<Integer> dataPointsX, List<Long> dataPointsY, String graphTitle) {
        ...
        this.graphTitle = graphTitle; // Set the graph title

        setTitle("Performance Graph Visualization - " + graphTitle); // Set the title of the window
    ...
    private void drawGraph(Graphics g) {
        ...
        g2.drawString(graphTitle, (width - titleWidth) / 2, padding / 2);
    ...
    /**
     * Gets the maximum y-axis value from the list of y-axis data points.
     *
